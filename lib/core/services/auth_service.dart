...
class AuthService {
  ...
  Future<Map<String, dynamic>> authenticate(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw AuthException(
          'Sign in failed. Please enter correct email/password.',
        );
      }
    } catch (e) {
  ...
  Future<String> getDeviceApiKey(String macAddress, String bearerToken) async {
    ...
    final endpoint =
        '$_baseUrl/Device/GetCredentials/$normalizedMac?controllerTypeId=1';
    ...
    try {
      ...
      throw AuthException(
        'Failed to get device credentials. Please try again.',
      );
    }
  }
